...
import json
from project_paths import input_file, model_file, config_file
...
torch.save(best_model_state, model_file('best_gnn_grouped.pt'))
with open(config_file('gnn_grouped_hyperparams.json'), 'w') as f:
    json.dump({
        'model': 'GCN',
