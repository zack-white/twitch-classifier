...
from project_paths import artifact_data_file, model_file, config_file
...
with open(config_file("xgboost_node2vec_meta.json"), "r") as f:
    meta = json.load(f)
...
joblib.dump(clf_stage1, model_file("stage1_EN_vs_NONEN.pkl"))
joblib.dump(clf_stage2, model_file("stage2_NONEN_groups.pkl"))
