...
import json
import os
from project_paths import artifact_data_file, model_file, figure_file
...
X = np.load(artifact_data_file("node2vec_embeddings.npy"))
...
plt.grid(True)
plt.tight_layout()
plt.savefig(figure_file("tsne_balanced_sample.png"), dpi=300)
plt.show()
